        ...
        <Row className="gy-4 mt-2">
          <Col lg={12} dir="rtl">
            ...
            <p dir="rtl" className="paragraph">
              ...
              ادارۀ مورد نظر ضمن ایفای وظیفۀ اصلی‌اش به مطالعه، تحقیق و پژوهش
              های تاریخی پرداخته، و کارهای تاریخی و پژوهشی ارزشمند و ماندگاری را
              در زمینۀ هرات‌شناسی و خراسان تاریخی خلق کرده است.
            </p>
            <p dir="rtl" className="paragraph">
            ...
            <p dir="rtl" className="paragraph">
              ...
              زن، مهاجر، دیار دارا، نوید، نامه‌ی بایسنغر، سال‌نامه‌ی فرگرد، پیام
              معلم، سازندگی و غیره منتشر شده است.
            </p>
            ...
            <p dir="rtl" className="paragraph">
              ...
              تاریخچه‌‎ی کروخ (کار مشترک) ، مخترع توأمان (شرح حال، احوال و آثار
              مجنون رفیقی هروی)، ناخدای نستعلیق خراسان (شرح حال، احوال و آثار
              میرعلی هروی)، تصحیح دیوان شحنه خراسانی (محمد مهدی‌خان اوبهی
              مازندرانی) و تصحیح شرح قصاید صنعتی حافظ علی عیشی از جمله آثار
              منتشرشده‌ی کام‌گار است.
            </p>
            <p dir="rtl" className="paragraph">
              تذکرة الشعرای هرات، آشنایی با بناهای تاریخی هرات ، شکوه جامی
              (معرفی و نسخه‌شناسی آثار مولانا نورالدین عبدالرحمان جامی)، جمع
              آوری مجموعه مقالات زنده یاد پوهاند دکتر جلال الدین صدیقی، سیمای
              گردشگری گذره، سفرنامه‌ی بادغیس و چند مجموعه‌ی تحقیقی و پژوهشی دیگر
              از آثار و کارهای روی دست حمیدالله کام‌گار است که مجموعه‌ی
              تذکرۀالشعرای هرات وآشنایی با بناهای تاریخی هرات از مهم‌ترین و
              ماندگارترین و پُر حجم‌ترین آثارش خواهد بود.
            </p>
          </Col>
        </Row>
      </Container>
